 ...
 * @returns {Component} a field that returns a field based on the type of the source or a custom text field if there is no typeMapper defined for the type of the source
 */
